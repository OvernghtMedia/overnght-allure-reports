...
- Name: ../api/subscription-duplicate-invariants.spec.ts >> Subscription duplicates — API invariants >> REGULAR_TOKEN: at most one active subscription row
- Location: api/subscription-duplicate-invariants.spec.ts:73:7

# Error details

```
Error: {"success":false,"message":"Cannot GET /api/v2.0/subscriptions","error":"Not Found","statusCode":404}
